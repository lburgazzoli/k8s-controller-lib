module github.com/lburgazzoli/k8s-controller-lib/examples/simple-controller
...
require (
	...
	github.com/k8s-manifest-kit/pkg v0.1.0 // indirect
...
replace github.com/lburgazzoli/k8s-controller-lib => ../..

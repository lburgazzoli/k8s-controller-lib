...
graph TB
    ...
    subgraph "k8s-controller-lib"
        ...
        Watch[Watch<br/>pkg/reconciler/watch]
...
- Integrates with watch for dynamic resource watching
...
**Default Handler:**
The watch feature uses `EnqueueRequestForOwnerOrLabel` which:
...
- [Watch Feature](design/watch.md) - Dynamic watch management
